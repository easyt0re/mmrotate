...
data = dict(
    ...
    train=dict(
        type='DOTADataset',
        ann_file='datasets/CASIA-Ship/train/labels/',
        img_prefix='datasets/CASIA-Ship/train/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='RResize', img_scale=(1024, 1024)),
    ...
    val=dict(
        type='DOTADataset',
        ann_file='datasets/CASIA-Ship/val/labels/',
        img_prefix='datasets/CASIA-Ship/val/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
    ...
    test=dict(
        type='DOTADataset',
        ann_file='datasets/CASIA-Ship/test/labels/',
        img_prefix='datasets/CASIA-Ship/test/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
model = dict(
    ...
    test_cfg=dict(
        ...
        max_per_img=2000))
classes = ('ship', 'submarine')
work_dir = './run_CASIA-Ship/oriented_reppoints'
auto_resume = 'True'
gpu_ids = [0]
