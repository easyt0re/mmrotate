...
from mmrotate.datasets.my_dts_custom import DDCustomDataset
...
class DDDOTADataset(DDCustomDataset):
    ...
    def __init__(self,
        ...
        super(DDDOTADataset, self).__init__(ann_file, pipeline, **kwargs)
